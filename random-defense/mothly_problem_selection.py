...
# 기하학, 물리학, 확률, 임의 정밀도 / 큰 수 연산 제외
queries = [
    '*s5 s#150.. %ko -#geometry -#physics -#probability -#arbitrary_precision',
    '*s4 s#150.. %ko -#geometry -#physics -#probability -#arbitrary_precision',
    '*s3 s#150.. %ko -#geometry -#physics -#probability -#arbitrary_precision',
    '*s2 s#150.. %ko -#geometry -#physics -#probability -#arbitrary_precision',
    '*s1 s#150.. %ko -#geometry -#physics -#probability -#arbitrary_precision',
    '*g5 s#150.. %ko -#geometry -#physics -#probability -#arbitrary_precision',
    '*g4 s#150.. %ko -#geometry -#physics -#probability -#arbitrary_precision',
    '*g3 s#150.. %ko -#geometry -#physics -#probability -#arbitrary_precision',
    '*g2 s#150.. %ko -#geometry -#physics -#probability -#arbitrary_precision',
    '*g1 s#150.. %ko -#geometry -#physics -#probability -#arbitrary_precision'
]
